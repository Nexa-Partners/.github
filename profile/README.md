...
<div style="display: flex; align-items: flex-start; gap: 20px; flex-wrap: wrap;">
  ...
  O projeto está sendo construído com base em tecnologias modernas, como **Go (Fiber)** no backend e **React** no frontend, e segue o objetivo de entregar um **MVP funcional até Janeiro de 2026**.
